...
<div class="barre4">
    ...
    <?php if (empty($duree_sommeil) || empty($dates)) : ?>
        <div class="no-data-message" style='font-family: "Liberation Serif";'>Il n'y a pas de données pour le moment.</div>
    <?php else : ?>
...
<canvas id="myChart2"></canvas>
    ...
    <h2 style='font-family: "Arial Rounded MT Bold", sans-serif; text-decoration: underline;'>Améliorations à prévoire :</h2>
    <ul>
