...
<div class="scale"><span>0</span><span>1</span><span>2</span><span>3</span><span>4</span><span>5</span>
  ...
  <span>6</span><span>7</span></div>
    ...
    <a class="bouton_retour" href="<?php if (!isset($_SESSION['client'])){echo 'utilisateur/connecter.php';}else{echo 'questionnaire/questionnaire_v2.php';}?>">Obtenir des conseils personnalisés</a>
