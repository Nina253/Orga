...
<html lang="fr">
	...
	<h3 style='font-family: "Montserrat"'>Ton guide pour mieux t’organiser et réussir</h3>
		...
		<a class="bouton_bleu" href="simulateur.php" style='font-family: "Silk Serif";font-size: 18px;'>Simulateur de performance</a>
	<p>Vous pouvez également commencer immédiatement en remplissant le questionnaire, qui vous permettra d’obtenir des conseils personnalisés en cliquant ci-dessous: </p>
		<a class="bouton_bleu" style='font-family: "Silk Serif";font-size: 18px;' href="<?php if (isset($_SESSION['client'])){echo 'questionnaire/questionnaire.php';}else{echo 'utilisateur/connecter.php';} ?>">Questionnaire</a>
		...
		<a class="bouton_bleu" href="/Orga/forum/forum.php" style='font-family: "Silk Serif";font-size: 18px;'>Forum</a>
	</div>	
